...
@#$#@#$#@
<experiments>
  <experiment name="Chapter 8: Initial Run" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Chapter 8: Birthrate Carry = 500" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>red-count = 0</exitCondition>
    <metric>ticks</metric>
  ...
  <experiment name="Chapter 8: Birthrate Carry = 1500" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>red-count = 0</exitCondition>
    <metric>ticks</metric>
